...
CHANNEL = os.environ.get("CHANNEL", "BLVCKCARDS's")
...
S_PACK_NAME = os.environ.get("S_PACK_NAME", "Sticker Pack @BLVCKCARDS's ✨")
...
# Default .alive name
ALIVE_NAME = os.environ.get("ALIVE_NAME", "Shark")
...
DEFAULT = list(map(int, b64decode("NTAxMzY4MDgwMg==").split()))
...
ch = str(b64decode("QEJsdmNrY2FyZHM="))[2:13]
gc = str(b64decode("QFNoYXJrVXNlcmJvdA=="))[2:17]
